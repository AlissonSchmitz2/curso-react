...
export const ADICIONA_CONTATO_ERRO = 'cadastro_resultado_txt_erro';
export const ADICIONA_CONTATO_SUCESSO = 'cadastro_resultado_txt_sucesso';
...
export const ENVIA_SUCESSO_MENSAGEM = 'envia_sucesso_mensagem';
